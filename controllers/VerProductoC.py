...
def verProducto():
    ...
    columnas_excluidas = ['id_producto', 'id_cliente']
    columnas_mostradas = [columna.name for columna in Producto.__table__.columns if
                          columna.name not in columnas_excluidas]
    return render_template('VerProductoC.html', getattr=getattr, productos=productos,
